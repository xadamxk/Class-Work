   ...
   public class Actor
   {
     ...
     */ 	
      public void moveTo(Location newLocation)
      {
         ...
         AgentCount = AgentCount - (Math.abs(location.getRow()-newLocation.getRow())+Math.abs(location.getCol()-newLocation.getCol()));
      ...
      */
         if ((this instanceof Agent || this instanceof RandomAgent) && other instanceof Pit)
         {
         	sound("fall");
				AgentCount = AgentCount - 1000;
         }
         else if ((this instanceof Agent || this instanceof RandomAgent) && other instanceof Wumpus)
         {
         	sound("devil");
				AgentCount = AgentCount - 1000;
         }
      ...
      public int getAgentCount()
      {
		...
		public void putAgentCount(int count)
		{
