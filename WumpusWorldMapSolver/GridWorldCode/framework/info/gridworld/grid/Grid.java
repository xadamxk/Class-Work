...
public interface Grid<E>
{
		...
		boolean heardScream();
      boolean getStench(Location loc);
      boolean getBreeze(Location loc);
      boolean getGlitter(Location loc);
		boolean grabGold(Location loc);
		void setGoldLocation(Location loc);
		void climb(Location loc);
    ...
    /**
     * Gets the valid locations adjacent to a given location in four
     * compass directions (north, east, south, west). <br />
     * Precondition: <code>loc</code> is valid in this grid
     * @param loc a location in this grid
     * @return an array list of the valid locations adjacent to <code>loc</code>
     * in this grid
     */
    ArrayList<Location> getValidTrueAdjacentLocations(Location loc);
